 ...
 * 
 * This file is generated by cppbind on 06/20/2022-11:10.
...
extern "C" JNIEXPORT void Java_doc_1scanner_DocCornerPointsExtractor_jComputecornerpoints(JNIEnv* env, jobject obj, jobjectid id){
    ...
    try {
        ...
        jclass excCls = env->FindClass("cppbind/exception_helpers/StdRangeError");
        jclass cppbindObjClass = env->FindClass("cppbind/alias/CppBindObject");
        ...
        jmethodID excConstructor = env->GetMethodID(excCls, "<init>", "(Lcppbind/alias/CppBindObject;)V");
